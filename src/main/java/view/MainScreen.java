...
public class MainScreen extends javax.swing.JFrame {
    ...
    public void decorateTableTask(){
        ...
        //criando o sort(ordenação) automático para as colunas da table
    ...
    private void showJTableTasks(boolean hasTasks) {
        if(hasTasks) { //Existem tarefas?
            if(jPanelEmptyList.isVisible()) { // Se a tela de lista vazia estiver visível
            ...
            jPanelEmptyList.setVisible(true); // torne a mensagem visível
